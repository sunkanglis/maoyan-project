        ...
        <div class="content">
           <div class="left">
               <div class="movie-title">
                   {{info.nm}}
                   <span class="version" v-if="info.version" :class="info.version"></span>
                   <!-- <span class="version v3d imax"></span> -->
               </div>
               <div class="detail">
                   <div class="score" v-if='info.sc == 0 '> 
                   ...
                   <div class="score" v-else> 
                    ...
                    <div class="actor line-ellipsis">主演: {{info.star}}</div>
                    <div class="show-info line-ellipsis">{{info.showInfo}}</div>
               </div>
