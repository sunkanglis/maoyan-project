<template>
    <footer class="footer">
        <router-link :to='item.path' active-class='active' v-for="item in foots" :key='item.id'>
            <svg width="50" height="50" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg"><title>电影1</title><g fill="#696969" fill-rule="evenodd" v-html="item.svg"></g></svg>
