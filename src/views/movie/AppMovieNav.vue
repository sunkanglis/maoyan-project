    ...
    <section class="app-nav">
        ...
        <div class="tabs">
            <router-link
                ...
                v-for='movienav in movienavs' 
                :key='movienav.id' 
                class="tab-item"
                :to='movienav.path'

            >{{movienav.title}}</router-link>
        </div>
        <a class="search"></a>
    </section>
</template>
